...
public class CreateOrderSagaTest {
  ...
  private ProductDetails productDetails = new ProductDetails(104L, 5);
  private OrderDetails orderDetails = new OrderDetails(customerId, orderTotal, productDetails);
